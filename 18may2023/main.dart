...
void game() {
  ...
  switch (userChoice) {
    case "1":
      userChoice = "Paper";
      print("Sizin seciminiz [Paper]");
      gameStart();
      break;
    case "2":
      userChoice = "Scissors";
      print("Sizin seciminiz [Scissors]");
      gameStart();
      break;
    case "3":
      userChoice = "Rock";
      print("Sizin seciminiz [Rock]");
      gameStart();
      break;
    default:
  ...
  switch (compChoice) {
    case "1":
      compChoice = "Paper";
      print("Kompyuterin Secimi [Paper]");
      gameStart();
      break;
    case "2":
      compChoice = "Scissors";
      print("Kompyuterin Secimi [Scissors]");
      gameStart();
      break;
    case "3":
      compChoice = "Rock";
      print("Kompyuterin Secimi [Rock]");
      gameStart();
      break;
    default:
      print("Lutfen Duzgun Sechim edin");
